  ...
  <div class="mt-4 sm:mt-10 sm:mx-0 lg:mx-44">
    ...
    <div class="flex justify-center">
      <ul
        ...
        <li @click="texto = 1"><a :class="[texto == 1 ? 'bg-purple-800 text-white' : '']">Participe</a></li>
        <li @click="texto = 2"><a :class="[texto == 2 ? 'bg-purple-800 text-white' : '']">5ª COREPSI-TO e 12ª CNP</a>
        </li>
        <li @click="texto = 3"><a :class="[texto == 3 ? 'bg-purple-800 text-white' : '']">Ações Mobilizadoras</a></li>
        <li @click="texto = 4"><a :class="[texto == 4 ? 'bg-purple-800 text-white' : '']">Pré Congressos</a></li>
        <li @click="texto = 5"><a :class="[texto == 5 ? 'bg-purple-800 text-white' : '']">Documentos</a></li>
        <li @click="texto = 6"><a :class="[texto == 6 ? 'bg-purple-800 text-white' : '']">Comorg</a></li>
        <li @click="texto = 7"><a :class="[texto == 7 ? 'bg-purple-800 text-white' : '']">Contato</a></li>
      </ul>
    </div>
    ...
    <div class="bg-base-100 rounded-md shadow-md mb-10 p-6 text-justify sm:p-2 textos text-black">
      <div v-if="texto == 1">
        ...
        <p>Em agosto de 2025, profissionais de Psicologia de todo o Brasil escolher&atilde;o novas chapas de
          representantes para os Conselhos Regionais e para o Conselho Federal de Psicologia. Por&eacute;m, antes do
        ...
        <ul class="p-4 list-disc">
          <li>Promover a organiza&ccedil;&atilde;o e mobiliza&ccedil;&atilde;o das pessoas Psic&oacute;logas do
            Tocantins, possibilitando a defini&ccedil;&atilde;o da contribui&ccedil;&atilde;o do Sistema Conselhos de
            Psicologia para o desenvolvimento da Psicologia como ci&ecirc;ncia e profiss&atilde;o;</li>
          <li>Garantir a participa&ccedil;&atilde;o das(os) Psic&oacute;logas(os) no processo de
            delibera&ccedil;&atilde;o acerca da&nbsp;a&ccedil;&otilde;es a serem desenvolvidas pelo Conselho Federal de
            Psicologia (CFP) e pelo&nbsp;Conselho Regional de Psicologia do Tocantins (CRP 23), favorecendo a
            valoriza&ccedil;&atilde;o e o&nbsp;protagonismo das(os) psic&oacute;logas(os), bem como a
            auto-organiza&ccedil;&atilde;o em rela&ccedil;&atilde;o &agrave;s&nbsp;etapas que precedem o Congresso
            Nacional da Psicologia (CNP);</li>
          <li>Apresentar propostas referentes ao tema do 12º Congresso Nacional da Psicologia&nbsp;(12&ordf; CNP), que
            subsidiem as diretrizes pol&iacute;ticas a serem implementadas e/ou reguladas pelo Conselho Federal de
            Psicologia (CFP) e Conselho Regional de&nbsp;Psicologia do Tocantins (CRP 23) para serem implementadas no
            pr&oacute;ximo tri&ecirc;nio;</li>
          <li>Garantir o espa&ccedil;o de articula&ccedil;&atilde;o para composi&ccedil;&atilde;o,
            inscri&ccedil;&atilde;o e apresenta&ccedil;&atilde;o de chapas&nbsp;que concorrer&atilde;o ao mandato do
            Conselho Regional de Psicologia do Estado do&nbsp;Tocantins, para a gest&atilde;o 2025-2028;</li>
          <li>Eleger as pessoas delegadas para o 12&ordm; CNP, que ser&aacute; realizado nos dias 03 a 06 de julho de
            2025.</li>
        </ul>
      </div>
      <div v-if="texto == 2">
        <h1 class="text-4xl text-center font-bold p-4"> 12ª COREPSI-TO </h1>
        <p>Ap&oacute;s a realiza&ccedil;&atilde;o dos Pr&eacute;-COREPSIs, as propostas aprovadas em cada regi&atilde;o
        ...
        <p><br>O processo de forma&ccedil;&atilde;o das diretrizes que orientam as gest&otilde;es regionais e federal
          ...
          Psicologia (12&ordm; CNP): Psicologia e Democracia: A Pluriversalidade do nosso fazer. Por uma psicologia
          pluriversa e inclusiva!</p>
        <p>Dentro desta tem&aacute;tica, as propostas devem estar alinhadas a um dos tr&ecirc;s eixos definidos pelo
          regulamento do 12&ordm; CNP:</p>
        <p><br><strong>I &ndash; Eixo 01</strong> &ndash; Sistema Conselhos de Psicologia: A organiza&ccedil;&atilde;o
          democr&aacute;tica e a participa&ccedil;&atilde;o da categoria na consolida&ccedil;&atilde;o de um sistema
          pluriverso e representativo;</p>
        <p><strong>II &ndash; Eixo 2</strong> &ndash; Interlocu&ccedil;&atilde;o com a sociedade:
          Articula&ccedil;&otilde;es das Psicologias brasileiras para a efetiva&ccedil;&atilde;o do Estado
          Democr&aacute;tico de Direito na perspectiva da interseccionalidade, considerando as vulnerabilidades a partir
          dos diferentes marcadores sociais, tais como: quest&otilde;es &eacute;tnico-raciais, socioecon&ocirc;micas,
          culturais, geracionais, sexualidade e g&ecirc;nero e das pessoas com defici&ecirc;ncia;</p>
        <p><strong>III &ndash; Eixo 3</strong> &ndash; Exerc&iacute;cio Profissional: O trabalho das psicologias na
          consolida&ccedil;&atilde;o da democracia com responsabilidade &eacute;tica, t&eacute;cnica e pol&iacute;tica,
          a partir de uma perspectiva pluriversa.</p>
      </div>
      <div v-if="texto == 3">
        <h1 class="text-4xl text-center font-bold p-4"> Ações Mobilizadoras </h1>
        <p>A organiza&ccedil;&atilde;o do 5&deg; Congresso Regional da Psicologia do Estado do Tocantins (5º
          COREPSI)&nbsp;ser&aacute; de responsabilidade do IV Plen&aacute;rio do CRP 23, por meio da Comiss&atilde;o
          Organizadora do&nbsp;Tocantins (COMORG-TO).</p>
        <p><br>Elas ocorrer&atilde;o nas seguintes modalidades:</p>
        <p><br><strong>1. Eventos Preparat&oacute;rios: </strong>Eventos de diferentes formatos, organizados pelo CRP
          23, que objetivam:</p>
        <p>articular e mobilizar amplamente profissionais da Psicologia, por meio de&nbsp;discuss&otilde;es de base,
          encontros tem&aacute;ticos, mesas redondas, debates on-line e outros, para a&nbsp;discuss&atilde;o da
          tem&aacute;tica do 5&deg; COREPSI e do 12º CNP, favorecendo a organiza&ccedil;&atilde;o da
          categoria&nbsp;profissional para o levantamento de quest&otilde;es profissionais, estimulando a
          elabora&ccedil;&atilde;o de&nbsp;propostas a serem apresentadas, apreciadas e votadas nos
          Pr&eacute;-congressos divulgando&nbsp;tamb&eacute;m no CNP.<br>a) Podem participar dos Eventos
          Preparat&oacute;rios: profissionais da Psicologia, estudantes,&nbsp;pessoas convidadas e quaisquer outras
          pessoas interessadas. Nos Eventos Preparat&oacute;rios n&atilde;o&nbsp;se elege delega&ccedil;&atilde;o para o
          12º CNP;<br>b) As(os) estudantes de psicologia, ser&atilde;o considerados aptas(os), apenas aqueles
          discentes&nbsp;matriculados em cursos de gradua&ccedil;&atilde;o de psicologia autorizados ou reconhecidos
          pelo MEC,&nbsp;mediante apresenta&ccedil;&atilde;o de comprovante de matr&iacute;cula atualizado,
          correspondente ao&nbsp;semestre vigente ao evento.</p>
        <p><br><strong>2. Eventos livres:</strong> S&atilde;o as a&ccedil;&otilde;es de mobiliza&ccedil;&atilde;o
          propostas pela categoria, de forma aut&ocirc;noma e&nbsp;podem ser organizadas por psic&oacute;logos ou por
          coletivos da psicologia, associa&ccedil;&otilde;es, sindicatos&nbsp;e/ou institui&ccedil;&otilde;es
          p&uacute;blicas e privadas de psicologia, bem como organiza&ccedil;&otilde;es estudantis
          de<br>psicologia.<br>a) O cadastro do evento livre dever&aacute; ser feito por uma pessoa f&iacute;sica, sendo
        ...
        <p>b) Os Eventos livres, dever&atilde;o ser realizados entre o per&iacute;odo de: 01 de setembro de 2024 a
          ...
          documento e envie para o e-mail &gt; <a class="text-blue-500 underline" :href="email_contato" target="_blank"
            rel="noopener">ouvidoria@crp23.org.br
          </a>
          <br>3.
      ...
      <div v-if="texto == 4">
        ...
        <ul class="p-4">
          ...
          <li>
            <strong>Encontro 3</strong> - 13 de dezembro de 2024 &agrave;s 09h - modalidade on-line;
          </li>
          <li>
            <strong>Encontro 4 </strong>- 17 de janeiro de 2025 - modalidade on-line;
          </li>
          <li>
            <strong>Encontro 5 </strong>- 24 de janeiro de 2025 - modalidade on-line;
          </li>
          <li>
            <strong>Encontro 6</strong> - 28 de janeiro de 2025 - presencial (subsede em Aragua&iacute;na);&nbsp;&nbsp;
          </li>
        </ul>
